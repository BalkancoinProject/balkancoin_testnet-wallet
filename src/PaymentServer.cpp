...
const QString BITCOIN_IPC_PREFIX("balkancoin:");

static QString ipcServerName()
{
    QString name("Balkancoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start balkancoin: click-to-pay handler");
    else
...
{
    // clicking on balkancoin: URLs creates FileOpen events on the Mac:
